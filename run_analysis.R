...
#Get Training Data
train_data <- read.table("train/X_train.txt",col.names=data_header$variable)
#Get Subject data
...
#Get testing Data
test_data <- read.table("test/X_test.txt",col.names=data_header$variable)
#Get Subject data
...
#Get Avereages by Activity and Subject
...
#Output final data to txt files
